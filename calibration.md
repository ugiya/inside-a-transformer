...
**Pre-known signal** (from initial the design grill intake on 2026-05-02):
...
**Resume instructions:**
- Re-invoke the design grill with the same args, OR continue from main thread with: "Resume calibration at T5 — apply the two probes above; close the sheet."
...
*Generated via the design grill knowledge-calibration round, paused at T5 for safety checkpoint per user request 2026-05-02 21:54 IDT.*
